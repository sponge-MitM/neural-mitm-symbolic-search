"""
SHA3-512 Stage-1 rule distillation (Ridge fitted to the NN1 soft labels).

Soft-label source (NN1, BlueMLP): 31-dim aggregate features of the blue scheme,
predicting the minimal reachable Stage-2 N_mix (min_u2).
  - Data:  sha3_512_blue_labels_*_features.npy (7936 blue schemes x 31 features)
...
DATA_F = os.path.join(DATA_DIR, 'sha3_512', 'sha3_512_blue_labels_8000_t5_features.npy')
DATA_L = os.path.join(DATA_DIR, 'sha3_512', 'sha3_512_blue_labels_8000_t5_labels.npy')
CKPT = os.path.join(DATA_DIR, 'sha3_512', 'model_blue_mlp.pt')
...
def main():
    ...
    out = os.path.join(OUT_DIR, 'rules_sha3_512_stage1.json')
