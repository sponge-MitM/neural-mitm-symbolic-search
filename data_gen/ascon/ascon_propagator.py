...
def extract_single_group_features(state_2d, prefix, channel='b'):
    'Function extract single group features.'
    f = {}
...
def extract_transition_features(states_dict, channel='b'):
    'Function extract transition features.'
    f = {}
    ch = channel
...
def extract_rb_interaction_features(states_dict):
    'Function extract rb interaction features.'
    f = {}
...
def extract_milp_linear_features(r_flat, b_flat):
    'Function extract milp linear features.'
    states = parse_all_states(r_flat, b_flat)
    f = {}
...
def extract_all_features_milp(r_flat, b_flat):
    'Function extract all features milp.'
...
if __name__ == '__main__':
    ...
    print(f"  single-group stats features: ~{n_single}")
    print(f"  transition features: {n_transition}")
    print(f"  red-blue interaction features: {n_rb}")
